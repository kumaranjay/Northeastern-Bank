		...
		<div class="container-fluid">
			<div class="row">
				...
				<div id="transferBody" class="col-md-offset-3 col-md-7"
					...
					<div class="col-md-3">
						<a id="existingUser" href="openCam"><img
							src="resources/images/webcam.png" height="96px"
							width="96px"><br /> Take photo of check using webcam</a>
					</div>
					<div class="col-md-offset-1 col-md-3">
						<a id="newUser" href="uploadChequePage"><img
							src="resources/images/upload.png" height="96px" width="96px"><br>Upload check from computer</a>
