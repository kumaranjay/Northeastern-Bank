			...
			<div class="row">
				<div class="col-md-2 sidebar" id="sidebar">
					<ul class="nav nav-sidebar">
						...
						<li class="active"><a href="depositCheck">Deposit Check<span
								style="font-size: 14px;"
				...
				<div id="transferBody" class="col-md-offset-2 col-md-7"
					style="margin-top: 100px;">
					<span style="background-color: #FF9191">${error}</span> <span
						style="background-color: #B3F0B3">${success}</span>
					<p class="lead">Upload image of the check</p>

					<form:form name="myform" commandName="cheque"
						enctype="multipart/form-data" action="uploadCheque">
						<form:input name="file-upload" type="file" path="image" />
						<br>
