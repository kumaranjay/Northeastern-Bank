			...
			<div class="row">
				<div class="col-md-2 sidebar" id="sidebar">
					<ul class="nav nav-sidebar">
						...
						<li class="active"><a href="customerWelcome">Home<span
				...
				<div class="col-md-offset-3 col-md-7 main">

					<div id="homeBody" class="col-md-4"><p class="lead">Your current available
						balance is $${user.balance}</p></div>
