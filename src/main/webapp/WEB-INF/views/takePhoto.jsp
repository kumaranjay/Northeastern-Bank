	...
	function takePhoto() {
		...
		$.ajax({
			...
			success : function(response) {
				...
				if (response == "success") {
					$('#transferBody').html(
							"The check has been deposited successfully.");
					$("#transferBody").css({
						color : "#2ECC71"
					});
					$("#transferBody").css('font-weight', 'bold');
					$("#transferBody").css('margin-left', '300px');
				}
			}
	...
	<div id="frame">
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div id="transferBody" class="col-md-offset-1 col-md-7"
					style="margin-top: 100px;">

					<p class="lead">Position the check properly using the webcam
						window and click on the capture button when ready</p>
